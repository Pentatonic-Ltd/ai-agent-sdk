...
class TESClient:
    ...
    def wrap(self, client, session_id=None, metadata=None, auto_emit=True):
        return wrap_client(self._config, client, session_id=session_id, metadata=metadata, auto_emit=auto_emit)
